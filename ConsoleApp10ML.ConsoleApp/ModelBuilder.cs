...
namespace ConsoleApp10ML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\xiaoyuz\AppData\Local\Temp\92a03b59-e8bf-4135-b5c0-37fd8368e95b.tsv";
        private static string MODEL_FILEPATH = @"../../../../ConsoleApp10ML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("Label", "Label")
                                      .Append(mlContext.Transforms.LoadImages("ImageSource_featurized", @"C:\Users\xiaoyuz\AppData\Local\Temp", "ImageSource"))
